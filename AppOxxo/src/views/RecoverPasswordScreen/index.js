                ...
                <VStack w='80%'>
                    <VStack space={5} w='100%' mb='50'>
                        <Box w='100%' borderRadius={5}>
                            <Input placeholder='Digite uma nova senha' style={styles.input} onChangeText={(e) => setPassword(e)} />
                        </Box>
                        <Box w='100%' borderRadius={5}>
                            <Input placeholder='Confirme a senha' style={styles.input} onChangeText={(e) => setConfirmPassword(e)} />
                        </Box>
                    </VStack>
                    <Center>
