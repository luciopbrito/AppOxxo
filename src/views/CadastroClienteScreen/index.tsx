...
import { Button, Box, Center, NativeBaseProvider, ScrollView, Text, VStack } from "native-base";
...
const CadastroClienteScreen: FunctionComponent<Props> = ({ navigation }) => {
	//context
	const { setAuthData } = useContext<AuthContextType>(AuthContext as any)
